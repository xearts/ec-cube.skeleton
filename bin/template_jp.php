...
define('LOCALE_DIR', realpath(PROJECT_DIR.'/vencode/ec-cube/ec-cube/src/Eccube/Resource/locale'));
define('TEMPLATE_DIR', realpath(PROJECT_DIR.'/vencode/ec-cube/ec-cube/src/Eccube/Resource/template'));
